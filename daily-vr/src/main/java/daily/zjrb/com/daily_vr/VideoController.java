...
public class VideoController implements View.OnClickListener
{
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.video_tool_imgFullscreen){
            if (player != null)
            {
                player.toFullScreen();
            }
        }else if(v.getId() ==  R.id.video_tool_tbtnGyro){
            if (player != null) {
                player.setGyroEnabled(!player.isGyroEnabled());
                tbtnGyro.setChecked(player.isGyroEnabled());
            }
        }else if (v.getId() == R.id.video_tool_tbtnVR){
            if (player != null)
            {
        ...
        }else if (v.getId() == R.id.video_tool_tbtnPlayPause){
    ...
    public void changeOrientation(boolean isLandscape, int NavigationH)
    {
        ...
        if (isLandscape)
        {
            ...
            timeParams.leftMargin = (int) rlPlayPro.getContext().getResources().getDimension(R.dimen.vr_voide_tool_middle);
        ...
        else
        {
            ...
            timeParams.leftMargin = (int) tvTime.getContext().getResources().getDimension(R.dimen.vr_little_spacing);
            tvTime.setLayoutParams(timeParams);
